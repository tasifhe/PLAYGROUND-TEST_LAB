...
public class SprintJumpingState : State
{
    ...
    public SprintJumpingState(Character _character, StateMachine _stateMachine) : base(_character, _stateMachine)
	{
	...
	public override void LogicUpdate()
    {
        ...
        {           
            ...
            airVelocity = airVelocity.x * character.cameraTransform.right+ airVelocity.z * character.cameraTransform.forward*2;
            airVelocity.y = 0f;
